...
AVSBenchDataset = ["ambulance_siren"]
...
def extract_frame_for_each_video(root_path, trimed_video_base_path, df_one_video):
    ...
    extract_frames_base_path = os.path.join(root_path, "visual_frames_original_resolution")
...
def extract_frames(
    root_path="/mnt/data/data/avsbench/Single-source/s4_data",
    csv_path="/mnt/data/data/avsbench/Single-source/s4_meta_data.csv"
):
