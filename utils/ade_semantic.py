...
# from model.seg.transform import ResizeLongestSide
from model.segment_anything.utils.transforms import ResizeLongestSide
from utils.ade_ins_category import ADE_SEMANTIC_CATEGORY


class ADESemantic(Dataset):
    def __init__(
        self,
        is_train: bool = True,
        ...
        for image_id in image_ids:
            ...
            label_path = os.path.join(
                root_dir, "annotations", sub_dir, image_id.replace("jpg", "png")
            )
        ...
        print(f"ade semantic has {len(self.images)} samples.")
    ...
    def __getitem__(self, index):
        ...
        for thing_id in np.unique(label):
            if thing_id == 0:
                continue
            ...
            gt_classes.append(int(thing_id))
...
class ADESemanticTokenized(ADESemantic):
    def __init__(
        self,
    ...
    def __getitem__(self, index):
        ...
        if random.random() < 0.0:
            ...
            sampled_class_num = 1
            unexist_classes = [
                k for k in ADE_SEMANTIC_CATEGORY.keys() if k not in unique_classes
            ]
        ...
        for c in sampled_classes:
            ...
            class_text = ADE_SEMANTIC_CATEGORY[c]
        ...
        if sampled_class_num == 1:
            ...
            class_text = ", ".join(gt_classes_text)
        ...
        dataset_dict["gt_classes"] = gt_classes_text
