...
class PhraseCut(object):
    ...
    def __init__(
        self, split, image_size=400, negative_prob=0, 
        aug=None, aug_color=False, aug_crop=True,
        min_size=0, remove_classes=None, with_visual=False, 
        only_visual=False, mask=None
    ):
        super().__init__()
        ...
        from utils.PhraseCutDataset.utils.refvg_loader import RefVGLoader
        ...
        self.base_path = "/mnt/data/data/phrasecut/"
    ...
    def load_sample(self, sample_i, j):
        ...
        img_file = join(self.base_path, "VG_100K", str(img_ref_data['image_id']) + '.jpg')
        if not os.path.exists(img_file):
            img_file = img_file.replace("VG_100K", "VG_100K_2")
