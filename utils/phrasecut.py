...
from .pc_subset import get_subset
...
class RefVGLoader(object):
    ...
    def __init__(self, split=None, phrase_handler=None, word_embed=None, allow_no_att=True, allow_no_rel=True,
        ...
        pc_dir = "/mnt/data/data/phrasecut/"
        img_info_fpath = os.path.join(pc_dir, "image_data_split.json")
        refer_fpaths = os.path.join(pc_dir, f"refer_{split}.json")
